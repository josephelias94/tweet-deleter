...
var (
	...
	ERROR_TW_D_TWEETS_FAILED_STATUS_CODE   = SFX_TW_D_TWEETS + "Request to delete a tweet failed | "
	ERROR_TW_D_L_TWEETS_FAILED_STATUS_CODE = SFX_TW_D_L_TWEETS + "Request to delete a like failed | "
	ERROR_TW_G_L_TWEETS_FAILED_STATUS_CODE = SFX_TW_G_L_TWEETS + "Request to get likes failed | "
	ERROR_TW_G_L_TWEETS_USER_UNSET         = SFX_TW_G_L_TWEETS + "User is not set"
	ERROR_TW_G_TWEETS_FAILED_STATUS_CODE   = SFX_TW_G_TWEETS + "Request to get tweets failed | "
	ERROR_TW_G_TWEETS_USER_UNSET           = SFX_TW_G_TWEETS + "User is not set"
	...
	ERROR_TW_S_USER_FAILED_STATUS_CODE     = SFX_TW_S_USER + "Request to get user failed | "
